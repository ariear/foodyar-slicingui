<template>
  <div class="w-[94vw] md:w-[500px] lg:container mx-auto flex lg:justify-around xl:justify-between items-center font-pupylinux pt-24 pb-36">
      <div class="lg:w-[300px] xl:w-[447px] md:text-center lg:text-left px-2 md:px-0">
          <p class="font-bold text-[#272042] text-[30px] md:text-[35px] lg:text-[40px] xl:text-[46px]">
              <span class="relative"><span class="absolute w-[110%] border-4 border-[#FBE0DC] rounded-xl bottom-3 left-0 z-10"></span><span class="relative z-20">Eat</span></span> 
